...
@section('page_title'){{ trans($trans_path.'content.common.manager') }} | {{ trans('admin/product-attribute/general.content.list.list') }} - {{ trans('general.admin_panel') }} @endsection
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin.product-attributes.index') }}">{{ trans('admin/product-attribute/general.content.common.manager') }} </a>
                </li>
            ...
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        ...
                        {{ trans($trans_path.'content.list.menu_list') }}
                    </small>
                </h1>
            </div><!-- /.page-header -->
