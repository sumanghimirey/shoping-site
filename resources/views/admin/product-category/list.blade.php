...
@section('page_title'){{ trans($trans_path.'content.common.manager') }} | {{ trans('admin/product-category/general.content.list.list') }} - {{ trans('general.admin_panel') }} @endsection
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}">{{ trans('admin/product-category/general.content.common.manager') }} </a>
                </li>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ trans($trans_path.'content.common.slug') }}</th>
                                       <th>{{ trans($trans_path.'content.common.short_desc') }}</th>
                                    ...
                                    @if ($data['rows']->count() > 0)
                                        ...
                                        @foreach($data['rows'] as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($row->main_image)
                                                            <img src="{{ asset('images/category/'.$row->main_image ) }}" alt="" width="50px">
                                                        @else
