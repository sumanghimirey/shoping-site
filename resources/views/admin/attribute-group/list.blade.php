...
@section('page_title'){{ trans($trans_path.'content.common.manager') }} | {{ trans('admin/attribute-group/general.content.list.list') }} - {{ trans('general.admin_panel') }} @endsection
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin.attribute-groups.index') }}">{{ trans('admin/attribute-group/general.content.common.manager') }} </a>
                </li>
