...
<div class="form-group">
    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> {{ trans($trans_path.'content.common.remark') }} </label>

    <div class="col-sm-9">
        <textarea name="remark" id="remark" cols="50" rows="10">{{ ViewHelper::getData('remark', isset($data['row'])?$data['row']:[]) }}</textarea>
    </div>
</div>
