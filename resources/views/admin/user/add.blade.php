            ...
            <div class="page-header">
                <h1>
                    {{ trans('admin/user/general.content.common.user_manager') }}                    <small>
                        ...
                        {{ trans('admin/user/general.content.add.add_form') }}                    </small>
                </h1>
            </div><!-- /.page-header -->
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="username" placeholder="Username" class="col-xs-10 col-sm-5">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="email" placeholder="Email" class="col-xs-10 col-sm-5">
                            </div>
                        </div>
